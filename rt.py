...
android_models=[]
try:
    xx = requests.get('https://github.com/ARSHAD ALI/HKR/blob/main/UAGNT.txt').text.splitlines()
    for line in xx:
...
usr=[]
try:
    xd=requests.get('https://github.com/ARSHAD ALI/HKR/blob/main/UAGNT.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
pyt=('python3.11')
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/ARSHAD ALI/HKR/blob/main/UAGNT.txt').text
        ua=open('.bbnew.txt','w')
...
\033[1;32m 
          ...
          ╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝
\033[1;93m--------------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m ARSHAD ALI 
\033[1;37m[-] GITHUB    :\033[1;32m ARSHAD ALI
\033[1;37m[-] VERSION   :\033[1;32m 0.1
\033[1;37m[-] STATUS    :\033[1;32m PREMIUM
--------------------------------------------------
\033[1;37m[-]Dear Paid user:
\033[1;37m[-]Be Happy 😊 , Stay Positive 😋
--------------------------------------------------""")
def linex():
    print('\033[1;32m----------------------------------------------')
def clear():
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/Rashid118/Approval/blob/main/Approval.txt").text
    if id in httpCaht:
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/ARSHAD ALI/HKR/blob/main/Approval.txt').text
